...
export const ui = {
	...
	snackHost:
		'snack-host fixed z-[60] inset-x-0 bottom-[calc(1.15rem+var(--safe-bottom))] flex flex-col-reverse items-center gap-[0.45rem] px-4 pointer-events-none max-sm:bottom-(--tab-bar-offset) max-sm:px-3',
	snack:
